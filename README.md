<img align="center" src="./img/do-responsive-web-development-in-react-nodejs-html-css-bootstrap.jpg"/>
...
```js
const DanielBarbieri = {
  Skills: [HTML5, CSS3, React.js, Redux.Js,
  NodeJS, C++, express, git,
  PostgrSQL, Python, sequelize],
  Proyects: [
      {APIClima: ['React', 'HTML5', 'fetch']},
      {PICountries: ['React', 'Redux', 'NodeJs', 'Express', 'Sequelize', 'PostgreSQL']}
    ],
}
```
